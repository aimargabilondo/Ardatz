...
$(document).ready(function(){
	...
	var DEFAULT_IKASGAI = '<?php echo $defaultsCrud->getValueByGelaAndParamName(5, 'IKASGAI'); ?>';
	var DEFAULT_IKASGAI_ID = '<?php echo $defaultsCrud->getValueByGelaAndParamName(5, 'IKASGAI-ID'); ?>';
	var DEFAULT_JARRERA_PERTSONALA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(5, 'JARRERA_PERTSONALA'); ?>';
	var DEFAULT_LANERAKO_JARRERA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(5, 'LANERAKO_JARRERA'); ?>';
	var DEFAULT_ARRETA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(5, 'ARRETA'); ?>';
...
<div class="container">
	<div class="center">
		<span class="jittery titulo-clase">5.</span>
...
<div class="container">
     ...
     <div class="col-md-4">
		...
		<form method='post' id='51' name='gela_5_mahai_1'>
...
<div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='52' name='gela_5_mahai_2'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="container">
     ...
     <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='53' name='gela_5_mahai_3'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='54' name='gela_5_mahai_4'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="container">
     ...
     <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='55' name='gela_5_mahai_5'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="col-md-1"></div>
	 <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='56' name='gela_5_mahai_6'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
