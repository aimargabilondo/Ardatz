...
//Application Title
define('APP_TITLE', '3N Order Manager');
...
$root_path = '/mnt/data/fakturak';	//$_SERVER['DOCUMENT_ROOT'];
...
// e.g. 'txt,html,css,js'
$allowed_file_extensions = 'doc,docx,xls,xlsx,pdf,tar,zip,gif,jpg,png,bmp';
...
$exclude_items = array('*.php', '*.html', '*.htm');
...
$folders = array();
$files = array();
$tmp_path = array_slice(explode("/",$path), -1);
$current_path = $tmp_path[0];
