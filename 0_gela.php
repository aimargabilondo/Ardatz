...
$(document).ready(function(){
	...
	var DEFAULT_IKASGAI = '<?php echo $defaultsCrud->getValueByGelaAndParamName(0, 'IKASGAI'); ?>';
	var DEFAULT_IKASGAI_ID = '<?php echo $defaultsCrud->getValueByGelaAndParamName(0, 'IKASGAI-ID'); ?>';
	var DEFAULT_JARRERA_PERTSONALA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(0, 'JARRERA_PERTSONALA'); ?>';
	var DEFAULT_LANERAKO_JARRERA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(0, 'LANERAKO_JARRERA'); ?>';
	var DEFAULT_ARRETA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(0, 'ARRETA'); ?>';
...
/*	$('input[name="ikasgai"]').val(DEFAULT_IKASGAI);
	$('input[name="ikasgai-id"]').val(DEFAULT_IKASGAI_ID);
	$('select[name="jarrera_pertsonala"]').val(DEFAULT_JARRERA_PERTSONALA);
	$('select[name="lanerako_jarrera"]').val(DEFAULT_LANERAKO_JARRERA);
	$('select[name="arreta"]').val(DEFAULT_ARRETA);*/
});
...
<div class="container">
	<div class="center">
		<span class="jittery titulo-clase">X.</span>
...
<div class="container">
     ...
     <div class="col-md-4">
		...
		<form method='post' id='51' name='gela_0_mahai_1'>
...
<div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='52' name='gela_0_mahai_2'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="container">
     ...
     <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='53' name='gela_0_mahai_3'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='54' name='gela_0_mahai_4'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="container">
     ...
     <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='55' name='gela_0_mahai_5'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="col-md-1"></div>
	 <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='55' name='gela_0_mahai_6'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
