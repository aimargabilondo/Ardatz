...
$(document).ready(function(){
	...
	var DEFAULT_IKASGAI = '<?php echo $defaultsCrud->getValueByGelaAndParamName(4, 'IKASGAI'); ?>';
	var DEFAULT_IKASGAI_ID = '<?php echo $defaultsCrud->getValueByGelaAndParamName(4, 'IKASGAI-ID'); ?>';
	var DEFAULT_JARRERA_PERTSONALA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(4, 'JARRERA_PERTSONALA'); ?>';
	var DEFAULT_LANERAKO_JARRERA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(4, 'LANERAKO_JARRERA'); ?>';
	var DEFAULT_ARRETA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(4, 'ARRETA'); ?>';
...
<div class="container">
	<div class="center">
		<span class="jittery titulo-clase">4.</span>
...
<div class="container">
     ...
     <div class="col-md-4">
		...
		<form method='post' id='41' name='gela_4_mahai_1'>
...
<div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='42' name='gela_4_mahai_2'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="container">
     ...
     <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='43' name='gela_4_mahai_3'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='44' name='gela_4_mahai_4'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="container">
     ...
     <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='45' name='gela_4_mahai_5'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="col-md-1"></div>
	 <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='46' name='gela_4_mahai_6'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
