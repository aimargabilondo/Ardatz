...
$(document).ready(function(){
	...
	var DEFAULT_IKASGAI = '<?php echo $defaultsCrud->getValueByGelaAndParamName(2, 'IKASGAI'); ?>';
	var DEFAULT_IKASGAI_ID = '<?php echo $defaultsCrud->getValueByGelaAndParamName(2, 'IKASGAI-ID'); ?>';
	var DEFAULT_JARRERA_PERTSONALA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(2, 'JARRERA_PERTSONALA'); ?>';
	var DEFAULT_LANERAKO_JARRERA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(2, 'LANERAKO_JARRERA'); ?>';
	var DEFAULT_ARRETA = '<?php echo $defaultsCrud->getValueByGelaAndParamName(2, 'ARRETA'); ?>';
...
<div class="container">
	<div class="center">
		<span class="jittery titulo-clase">2.</span>
...
<div class="container">
     ...
     <div class="col-md-4">
		...
		<form method='post' id='21' name='gela_2_mahai_1'>
				...
				<tr>
						<td>
							<div class='input-group date' id='datetimepicker1'>
								<input type='text' class="form-control" name='datetimepicker' readonly />
								<span class="input-group-addon">
									<span class="glyphicon glyphicon-time"></span>
								</span>
							</div>
...
<div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='22' name='gela_2_mahai_2'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="container">
     ...
     <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='23' name='gela_2_mahai_3'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='24' name='gela_2_mahai_4'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="container">
     ...
     <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='25' name='gela_2_mahai_5'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
...
<div class="col-md-1"></div>
	 <div class="col-md-4">
        <div class="btn btn-block btn-lg btn-mesa" data-toggle="modal" data-target="#mymodal">
		<form method='post' id='26' name='gela_2_mahai_6'>
			<table class='table table-bordered'>
				<tr>
					<td>
						<div class="search-box ikasle">
