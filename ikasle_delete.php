...
if(isset($_SESSION['valid'])) {			
	...
	{
		$id = $_GET['delete_id'];
		$ikasleCrud->delete($id);
		header("Location: ikasle_delete.php?deleted");	
	}
...
<div class="container">
	 ...
	 if(isset($_GET['delete_id']))
	 {
         ...
         <?php
         $stmt = $DB_con->prepare("SELECT * FROM tbl_ikasle WHERE id=:id");
...
if(isset($_GET['delete_id']))
{
    ...
    <a href="ikasle_view.php" class="btn btn-large btn-success"><i class="glyphicon glyphicon-backward"></i> &nbsp; Ez</a>
    </form>  
	<?php
}
else
